package com.steven.core.config;
...
import com.steven.core.handler.GlobalExceptionUtil;
...
import com.steven.common.annotation.CommonNoRepeat;
import com.steven.common.annotation.CommonWrapper;
import com.steven.common.cache.CommonCacheOperator;
import com.steven.common.enums.CommonDeleteFlagEnum;
...
import com.steven.common.util.CommonTimeFormatUtil;
...
@Configuration
@MapperScan(basePackages = {"com.steven.**.mapper"})
public class GlobalConfigure implements WebMvcConfigurer {
    ...
    public static class CommonWrapperAop {
         ...
         * 切入点
         */
        @Pointcut("@annotation(com.steven.common.annotation.CommonWrapper)")
