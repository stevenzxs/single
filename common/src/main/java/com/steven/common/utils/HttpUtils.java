...
public class HttpUtils {
    ...
    public static RequestResult sendPostForm(String url, Map<String, String> header, Map<String, String> param) {
        String infoMessage =  new StringBuilder().append("request postForm，url:").append(url).append("，header:").append(JsonUtil.getInstance().write(header)).append("，param:").append(JsonUtil.getInstance().write(param)).toString();
        if(log.isDebugEnabled()){
