package com.steven.dev.modular.file.service.impl;
...
import com.steven.common.prop.CommonProperties;
import com.steven.common.util.CommonDownloadUtil;
import com.steven.common.util.CommonResponseUtil;
import com.steven.dev.modular.file.entity.DevFile;
import com.steven.dev.modular.file.enums.DevFileEngineTypeEnum;
import com.steven.dev.modular.file.mapper.DevFileMapper;
...
import com.steven.dev.modular.file.util.DevFileAliyunUtil;
import com.steven.dev.modular.file.util.DevFileLocalUtil;
import com.steven.dev.modular.file.util.DevFileMinIoUtil;
import com.steven.dev.modular.file.util.DevFileTencentUtil;
    ...
    private String storageFile(String engine, MultipartFile file, boolean returnFileId) {
        ...
        if(engine.equals(DevFileEngineTypeEnum.LOCAL.getValue())) {
            ...
            if(ObjectUtil.isEmpty(apiUrl)) {
                throw new CommonException("后端域名地址未正确配置：steven.config.common.backend-url为空");
            }
