...
import com.steven.sys.modular.user.result.SysUserOwnPermissionResult;
...
import com.steven.sys.modular.user.result.SysUserOwnResourceResult;
 ...
 **/
@Api(tags = "用户控制器")
@ApiSupport(author = "STEVEN_TEAM", order = 9)
@RestController
@Validated
